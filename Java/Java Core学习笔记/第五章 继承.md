 ...
 * @LastEditTime: 2024-03-27 17:50:26
...
5. 如果数组列表里很多元素并且需要经常修改，考虑使用linkedList（TODO 第九章）；
...
11. reflection 对于systems programming很有用，但是用于applications不恰当
